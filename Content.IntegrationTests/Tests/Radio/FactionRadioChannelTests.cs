...
public sealed class FactionRadioChannelTests
{
    ...
    public async Task FactionChannelOnlyDeliversToCurrentCompany()
    {
        ...
        await server.WaitAssertion(async () =>
        {
            ...
            var alliedComp = entMan.GetComponent<RadioReceiveCounterComponent>(alliedRadio);
            var outsiderComp = entMan.GetComponent<RadioReceiveCounterComponent>(outsiderRadio);
